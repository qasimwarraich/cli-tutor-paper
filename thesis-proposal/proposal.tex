...
utility shipping along side the extremely popular terminal based text editor
Vim. A secondary goal would be to wrap the shell learning tool in a web
application in order to make it more accessible and portable. To validate the
tool, a user study will be conducted, most likely with bachelor students at the
